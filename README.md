...
You can then execute your native executable with: `./build/rest-kotlin-exemplar-1.0.0-runner`
...
This exemplar was created with the following command
```
mvn io.quarkus.platform:quarkus-maven-plugin:2.6.0.Final:create \
-DprojectGroupId=my-groupId \
-DprojectArtifactId=rest-kotlin-exemplar \
-DprojectVersion=my-version \
-DclassName="org.my.group.ExemplarResource" \
